...
<svelte:head>
	<title>Support Us - XprismPlay</title>
...
<div class="container mx-auto space-y-8 p-6">
	<div class="flex flex-col items-center justify-center gap-4 py-8 text-center">
		...
		<h1 class="text-4xl font-bold tracking-tight">All the Ads (Support Us!)</h1>
		<p class="text-muted-foreground max-w-2xl text-lg">
			Thank you for wanting to support us! We've contained all our ads exclusively to this page so
			the rest of your experience stays completely ad-free.
		</p>
	</div>

	<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
		<div
			class="bg-card flex min-h-[300px] items-center justify-center overflow-hidden rounded-xl border p-4"
		>
			<ins
				class="adsbygoogle"
