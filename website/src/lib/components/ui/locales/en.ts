export default {
  ...
  groups: {
    ...
    create: {
      ...
      description:
        "Costs ${{cost}} to create a group. You can create up to {{max}} groups.",
      name_label: "Name",
    ...
    detail: {
      ...
      delete_dialog: {
        title: "Delete Group",
        description:
          "This is permanent. Treasury funds will be refunded to you.",
        confirm: "Delete",
        deleting: "Deleting...",
      },
      wall: {
  ...
  leaderboard: {
    ...
    portfolio: {
      ...
      description:
        "Users with the largest total portfolio valuations (including illiquid)",
